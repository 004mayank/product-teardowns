...
# WhatsApp — Product Teardown (v2)

> Lens: Product Manager • Scope: **publicly observable behavior only** (no internal Meta data claims)
>
> v2 intent: go deeper on **funnels, metric definitions, segments, and trade-offs**. (v1 remains unchanged.)

---

## 0) Product in one sentence (re-stated)
...
**Activation definition (v2, PM-usable):**
...
## 7) Constraints and trade-offs (expanded)
...
## Appendix: v2 deltas vs v1
- Added segment-based framing
- Defined activation (A1/A2/A3) and loop-specific metrics
- Broke down explicit funnels (new, reactivation, invite, group scaling)
- Added experiment ideas with measurable outcomes
- Added an instrumentation skeleton
